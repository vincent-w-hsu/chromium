...
#ifndef DEVICE_VR_ACERXR_TEST_TEST_HOOK_H_
#define DEVICE_VR_ACERXR_TEST_TEST_HOOK_H_

namespace device {

// Update this string whenever either interface changes.
constexpr char kChromeAcerXRTestHookAPI[] = "ChromeTestHook_1";
...
class TestHookRegistration {
 public:
  virtual void SetTestHook(AcerXRTestHook*) = 0;
};
